...
def main(args):
    ...
    model = models.UNet3SEbMetaOnly(n_channels=3, n_classes=2, meta_length = 2, bilinear=False).to(device) # type: ignore
    ...
    s_up = steps * args.num_epochs//args.cycles  
    ...
    trainer_object = Trainer_lr(model=model,
                    ...
                    saving_milestone = args.milestone,
